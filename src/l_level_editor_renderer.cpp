...
//     static float angleRot{0.f};
//     static float axisRotX{transform._rotation.x};
//     static float axisRotY{transform._rotation.y};
//     static float axisRotZ{transform._rotation.z};

//     static float scaX{transform._scale.x};
//     static float scaY{transform._scale.y};
//     static float scaZ{transform._scale.z};

//     ImGui::SliderFloat("Pos X", &posX, 0.f, 10.f);
//     ImGui::SliderFloat("Pos Y", &posY, 0.f, 10.f);
//     ImGui::SliderFloat("Pos Z", &posZ, 0.f, 10.f);

//     ImGui::SliderFloat("Angle Rotation", &angleRot, 0.f, 360.f);
//     ImGui::SliderFloat("Axis Rotation X", &axisRotX, 0.f, 1.f);
//     ImGui::SliderFloat("Axis Rotation Y", &axisRotY, 0.f, 1.f);
//     ImGui::SliderFloat("Axis Rotation Z", &axisRotZ, 0.f, 1.f);

//     ImGui::SliderFloat("Scale X", &scaX, 0.f, 10.f);
//     ImGui::SliderFloat("Scale Y", &scaY, 0.f, 10.f);
//     ImGui::SliderFloat("Scale Z", &scaZ, 0.f, 10.f);

//     angleRot = glm::radians(angleRot) * 0.5f;

//     // TODO: using ECS here is bad,bad,badbadbabadb
//     _ecs.AddTransformComponent(
//         selectedEntity,
//         transform_component{glm::quat(glm::cos(angleRot), axisRotX * glm::sin(angleRot),
//                                       axisRotY * glm::sin(angleRot), axisRotZ * glm::sin(angleRot)),
//                             glm::vec3(posX, posY, posZ), glm::vec3(scaX, scaY, scaZ)});
