...
namespace lain
{
    namespace resource_manager {
        ...
        static unsigned int CompileAndLinkShaders(std::filesystem::path const& vertex, std::filesystem::path const& fragment);
        ...
        shader CreatePrimitiveVAO(std::vector<float> const& vertices, GLenum const usage)
        {
        ...
        shader CreateCubeVAO(std::vector<float> const& vertices,
                             GLenum const usage,
