...
- Refactor event and mesh files
- Reimplement entity moving using sliders
- Add a visual ray that shows where my mouse is pointing at the moment (to see if grabbing the object works)
- Implement entity picking using the cursor
